...
public class Visual {
	...
	public Visual(){
		...
		backgroundPic = new JLabel("", new ImageIcon(getClass().getResource("/images/background2.png")), JLabel.CENTER);;
		
		PlyrHitmarkerPanel = new JPanel();
		CpuHitmarkerPanel = new JPanel();
		// set up the image for the hitmarker.
		hitmarker1 = new JLabel(new ImageIcon(getClass().getResource("/images/hitmarker.png")));
		hitmarker2 = new JLabel(new ImageIcon(getClass().getResource("/images/hitmarker.png")));
		...
		shield1 = new JLabel(new ImageIcon(getClass().getResource("/images/Shield.png")));
		shield2 = new JLabel(new ImageIcon(getClass().getResource("/images/Shield.png")));

		beamPanel1 = new JPanel();
		beamPanel2 = new JPanel();
		beam1 = new JLabel(new ImageIcon(getClass().getResource("/images/Beam1.png")));
		beam2 = new JLabel(new ImageIcon(getClass().getResource("/images/Beam2.png")));
	...
	public void displayPlayerImage(String imageName) {
		plyrPokemon = new JLabel(new ImageIcon(getClass().getResource("/images/" + imageName)));
	...
	public void displayCPUImage(String imageName){
		cpuPokemon = new JLabel(new ImageIcon(getClass().getResource("/images/" + imageName)));
