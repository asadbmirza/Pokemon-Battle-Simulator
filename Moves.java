...
class Moves {
  //All 8 attribute a move can have
  private String name;
  ...
  private double reductionHP;
  private double reductionATK;
  private double reductionDEF;
  private double reductionSpAtk;
  private double reductionSpDef;
  private double reductionSPEED;
  ...
  public Moves(String s) {
    name = s;
    try {
      Scanner in = new Scanner(new FileReader("Pokemon Moves.txt"));
      String line = "";
